...
<div class="jumbotron">
    ...
    <p><a href="javascript:;" class="btn btn-primary btn-lg" role="button">Learn more &raquo;</a>
    </p>
</div>
...
<div class="dropdown theme-dropdown clearfix">
    <a id="dropdownMenu1" href="javascript:;" role="button" class="sr-only dropdown-toggle" data-toggle="dropdown">Dropdown <b class="caret"></b></a>
    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
        <li class="active" role="presentation"><a role="menuitem" tabindex="-1" href="javascript:;">Action</a>
        </li>
        <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:;">Another action</a>
        </li>
        <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:;">Something else here</a>
        </li>
        <li role="presentation" class="divider"></li>
        <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:;">Separated link</a>
        </li>
    </ul>
</div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="javascript:;">One more separated link</a>
                        </li>
                    </ul>
                </li>
            </ul>
